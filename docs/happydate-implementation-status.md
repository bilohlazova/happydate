...
| Continuous quality gate | Implemented in repository | Read-only GitHub Actions workflow runs locked install, dependency audit, verify, production build, runtime smoke, Android debug compile and unsigned iOS Simulator compile; GitHub branch protection remains external |
