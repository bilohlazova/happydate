    ...
    <>
      <style>{`
        ...
        .pp-search {
          ...
          background: #fff; border: 1.5px solid #e8e3f5;
          border-radius: 14px; padding: 0 14px;
          box-shadow: 0 1px 4px rgba(0,0,0,0.04);
        }
        .pp-search input {
          flex: 1; border: none; background: transparent;
          padding: 11px 0; font-size: 14px; font-family: 'Plus Jakarta Sans', sans-serif;
          color: #1a1040; outline: none;
        }
        ...
        .pp-filter-chip {
          flex-shrink: 0; border: 1.5px solid #e8e3f5; background: #fff;
          border-radius: 20px; padding: 5px 14px;
          font-size: 12px; font-weight: 600; color: #7c6f9f;
        ...
        .pp-section-title { font-size: 12px; font-weight: 700; color: #b0a8cc; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 8px; }
        ...
        .pp-upcoming-card {
          ...
          padding: 10px 14px; border: 1.5px solid #fde8f5;
          cursor: pointer; transition: transform 0.15s;
          box-shadow: 0 1px 4px rgba(0,0,0,0.04);
        }
        .pp-upcoming-card:active { transform: scale(0.96); }
        ...
        .pp-card:active { transform: scale(0.985); border-color: #c4b5f8; }
        ...
        .pp-modal {
          ...
          animation: ppSlideUp 0.28s cubic-bezier(0.34,1.2,0.64,1);
        }
        ...
        .pp-label { font-size: 12px; font-weight: 700; color: #7c6f9f; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 6px; display: block; }
        .pp-input {
          width: 100%; border: 1.5px solid #e8e3f5; border-radius: 14px;
          padding: 12px 14px; font-size: 15px; font-family: 'Plus Jakarta Sans', sans-serif;
          color: #1a1040; background: #f8f7ff; outline: none;
        ...
        .pp-rel-btn {
          border: 1.5px solid #e8e3f5; border-radius: 12px;
          background: #f8f7ff; padding: 8px 4px;
        ...
        .pp-btn-cancel {
          flex: 1; border: 1.5px solid #e8e3f5; background: #f8f7ff;
          border-radius: 14px; padding: 13px; font-size: 15px;
          font-weight: 700; color: #7c6f9f; cursor: pointer;
        ...
        .pp-btn-save:active:not(:disabled) { transform: scale(0.97); }
      `}</style>
      ...
      <div className="pp-root">
        ...
        <div className="pp-filters">
          <button
            className={`pp-filter-chip ${filterRel === "all" ? "active" : ""}`}
          ...
          {RELATIONS.map(r => (
            <button
              key={r.value}
              className={`pp-filter-chip ${filterRel === r.value ? "active" : ""}`}
        ...
        <div className="pp-list">
          {loading && (
            <div style={{ textAlign: "center", padding: 40, color: "#b0a8cc", fontSize: 14 }}>
              Ładowanie...
            </div>
          )}
          ...
          {!loading && filtered.length === 0 && (
            <div className="pp-empty">
              ...
              <div className="pp-empty-title">
                {search ? "Nie znaleziono" : "Brak osób"}
              </div>
              <div className="pp-empty-sub">
                {search
                  ? `Brak wyników dla "${search}"`
                  : "Dodaj pierwszą osobę — zapamiętaj co ją uszczęśliwia ✨"}
              </div>
            </div>
          )}
        ...
        >
          <div className="pp-modal">
            ...
            <div className="pp-field">
              ...
              <div className="pp-rel-grid">
                {RELATIONS.map(r => (
                  <button
                    key={r.value}
                    className={`pp-rel-btn ${newRelation === r.value ? "active" : ""}`}
                    onClick={() => setNewRelation(r.value)}
                  >
            ...
            <div className="pp-modal-actions">
              <button className="pp-btn-cancel" onClick={() => setShowModal(false)}>
                Anuluj
              </button>
              <button
