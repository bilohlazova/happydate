...
export interface MemoryRow {
  ...
  knowledge_reviewed_at: string | null;
  knowledge_review_snoozed_until: string | null;
  is_active: boolean;
}

/** Explicit full-row projection shared by canonical client/server repositories. */
export const MEMORY_ROW_COLUMNS =
  "id, user_id, person_id, event_id, content_text, audio_url, transcript_text, images, ai_summary, ai_tags, ai_emotional_score, created_at, updated_at, type, title, value_text, occurred_on, importance, source, source_record_id, source_excerpt, user_confirmed_at, capture_schema_version, knowledge_reviewed_at, knowledge_review_snoozed_until, is_active";
